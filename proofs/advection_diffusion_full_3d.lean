...
namespace advection_diffusion_full_3d
...
noncomputable def xDiffusiveFluxExprs (C : Coordinates) (P : Parameters) (U : State) (DU : SpatialGradient) : DiffusiveFlux :=
  ...
  let f_z := DU.f_z
  {
    diffusive_flux_f := ((Dxx * f_x) + (Dxy * f_y) + (Dxz * f_z))
  }
...
noncomputable def yDiffusiveFluxExprs (C : Coordinates) (P : Parameters) (U : State) (DU : SpatialGradient) : DiffusiveFlux :=
  ...
  let f_z := DU.f_z
  {
    diffusive_flux_f := ((Dyx * f_x) + (Dyy * f_y) + (Dyz * f_z))
  }
...
noncomputable def zDiffusiveFluxExprs (C : Coordinates) (P : Parameters) (U : State) (DU : SpatialGradient) : DiffusiveFlux :=
  ...
  let f_z := DU.f_z
  {
    diffusive_flux_f := ((Dzx * f_x) + (Dzy * f_y) + (Dzz * f_z))
  }
...
end advection_diffusion_full_3d

namespace advection_diffusion_full_3d_lax_friedrichs

open advection_diffusion_full_3d
...
end advection_diffusion_full_3d_lax_friedrichs

namespace advection_diffusion_full_3d_minmod
...
end advection_diffusion_full_3d_minmod

namespace advection_diffusion_full_3d_centered_diffusion
...
end advection_diffusion_full_3d_centered_diffusion
