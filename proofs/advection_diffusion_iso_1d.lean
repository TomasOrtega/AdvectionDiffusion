...
namespace advection_diffusion_iso_1d
...
end advection_diffusion_iso_1d

namespace advection_diffusion_iso_1d_lax_friedrichs

open advection_diffusion_iso_1d
...
end advection_diffusion_iso_1d_lax_friedrichs

namespace advection_diffusion_iso_1d_minmod
...
end advection_diffusion_iso_1d_minmod

namespace advection_diffusion_iso_1d_centered_diffusion
...
structure InterfaceState1D where
...
noncomputable def interfaceState (CL : Coordinates) (CR : Coordinates)
    (UL : State) (UR : State) (P : Parameters) : InterfaceState1D :=
  {
...
theorem xInterfaceGradientConsistency (C_Lx : Coordinates) (C_Rx : Coordinates)
    (Ux: State) (P : Parameters) :
    ((xInterfaceGradientExprs C_Lx C_Rx Ux Ux P).interface_f_x) = 0.0 := by
...
theorem xInterfaceGradientAntisymmetric (C_Lx : Coordinates) (C_Rx : Coordinates)
    (U_Lx : State) (U_Rx : State) (P : Parameters) :
    ((xInterfaceGradientExprs C_Lx C_Rx U_Lx U_Rx P).interface_f_x) = -((xInterfaceGradientExprs C_Lx C_Rx U_Rx U_Lx
      P).interface_f_x) := by
  . simp [xInterfaceGradientExprs]
    ring_nf

end advection_diffusion_iso_1d_centered_diffusion
